...
public class GenCallClosure {
	public static void main(String[] args) {
		if (args.length < 1 ) {
			System.out.println("Usage: "
					+ "Input: a .csv file that contains the result of [call*].\n"
					+ "Output: 1. a .csv file of callClosure relationship.\n"
			...
			try {
				...
				// create writers
				writer = new BufferedWriter(new FileWriter("callClosure.csv"));
		    	...
		    	while ((line = reader.readLine()) != null) {
					...
					// generate condition for current line: the callClosure relationship
					String condition = "";
					for (String pc : PCset) {
					...
					String callClosure = startID + "\t" + endID + "\t" 
									+ "callClosure" + "\t" + condition + "\n";
					
					// write the callClosure fact to "callClosure.csv"
					writer.write(callClosure);
		    	}
		    	
		    	writer.close();
		    	System.out.println("Finish writing callClosure.csv");
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
