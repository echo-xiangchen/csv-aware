...
public class GenVPwrite {
	public static void main(String[] args) {
		if (args.length < 1 ) {
			System.out.println("Usage: "
					+ "Input: a .csv file that contains the result of [varWrite|parWrite].\n"
					+ "Output: 1. a .csv file of VPwrite relationship.\n"
			...
			try {
				...
				// create writers
				writer = new BufferedWriter(new FileWriter("VPwrite.csv"));
		    	...
		    	while ((line = reader.readLine()) != null) {
					...
					// generate condition for current line: the VPwrite relationship
					String condition = "";
					for (String pc : PCset) {
					...
					writer.write(VPwrite);
				}
					
				writer.close();
			    System.out.println("Finish writing VPwrite.csv");
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
